...
export default function AboutPage() {
  return (
    <StaticPageShell
      ...
      intro="FoodHub helps customers order confidently, helps restaurants manage service smoothly, and gives riders the tools they need to complete deliveries reliably."
    >
      <article className="surface-panel p-6">
        <h2 className="text-2xl font-semibold text-ink">What FoodHub focuses on</h2>
