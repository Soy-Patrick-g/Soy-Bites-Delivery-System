...
export default function PrivacyPage() {
  return (
    <StaticPageShell
      eyebrow="Privacy"
      title="How FoodHub handles your information"
      intro="FoodHub uses account, order, and delivery information to operate the platform, support secure transactions, and improve order fulfillment."
    >
